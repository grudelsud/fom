...
--
-- Host: localhost
-- Generation Time: Mar 20, 2011 at 06:36 PM
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='where all the clusters are stored' AUTO_INCREMENT=48068 ;
...
CREATE TABLE IF NOT EXISTS `fom_link` (
  ...
  PRIMARY KEY (`id_link`),
  UNIQUE KEY `uri` (`uri`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=266203 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='association between geo coords and user defined names' AUTO_INCREMENT=152083 ;
...
CREATE TABLE IF NOT EXISTS `fom_post` (
  ...
  KEY `src_id` (`src_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='contains all sources indexed for search and clustering' AUTO_INCREMENT=2640701 ;
...
CREATE TABLE IF NOT EXISTS `fom_postlink` (
  ...
  KEY `id_post` (`id_post`),
  KEY `id_link` (`id_link`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=312139 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='queries history, uses fom_querytag to store terms' AUTO_INCREMENT=22 ;
